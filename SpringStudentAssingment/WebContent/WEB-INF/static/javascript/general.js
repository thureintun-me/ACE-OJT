...
function menu(){
    ...
    html = html +'<ul>'
    html = html +'<li><a href="/SpringStudentAssingment/classmanagement">Class Registration</a></li>';
    html = html +'<li><a href="/SpringStudentAssingment/studentSearch">Student Search</a></li>';
    html = html +'<li><a href="/SpringStudentAssingment/setupAddStudent">Student Registration</a></li>';
    html = html +'</ul>';
    html = html +'</li>';
    html = html +'<li id="no-child">';
    html = html +'<a href="/SpringStudentAssingment/usermanagement" style="font-weight:bold;">User Management</a>';
    html = html +'</li>';
    html = html +'</ul>';
    html = html +'</div>';
