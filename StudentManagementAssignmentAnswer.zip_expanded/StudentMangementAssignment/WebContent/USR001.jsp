		...
		<div id="main_contents">
			<div id="contents">
				<div class="search_form">
					...
					</a> <input type="button" value="Reset" onclick="USR001.jsp"
						class="button" /> <br /> <br />
					<div id="errormsg">
				...
				<div id="list">
					...
					<table class="resultTable">
						...
						<c:forEach items="${userlist}" var="list">
							<tr>
								<td>
									<form action="UserDeleteServlet" id="deleteuser">
										<input type="hidden" name="userId" value="${list.id}" /> <input
											type="button" value="Delete" id="delete" class="button"
											onclick="checkDelete()" />
									</form>
								</td>
								<td><a href="UserUpdateServlet?id=${list.id}"> <input
