...
public class LoanController {
	...
	public ModelAndView searchCustomer(Model model,
		...
		return new ModelAndView("loan/MFI_LON_01");
	}
	...
	public String addLoanInfo(@Valid @ModelAttribute("loanInfoForm") LoanInfoForm loanInfoForm,
		...
		if (loaninfo.size() ==0 ) {
			...
			return "redirect:/searchloanInfo?message="+message;
		} else {
