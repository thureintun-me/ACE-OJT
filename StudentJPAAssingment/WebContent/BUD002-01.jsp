		...
		<div id="main_contents">
			<div id="contents">
				<div class="search_form">
					...
					<label id="errormsg"> ${err} </label> <label style="color: blue;"></label>
					<br />
					<br />
					<br />
					<form action="StudentUpdateServlet" method="post" id="myform">
						<input type="hidden" name="id" class="txtlong" value="${bean.studentId}" />
						...
						<div id="btnGroup">
							...
							<a href="StudentDeleteServlet?id=${bean.studentId}"> <input
										type="button" value="delete" class="button" id="delete" onclick="deleteStudent()" />
								</a>
							</div>
					</form>
					<input action="" type="submit" value="Back" class="button"
						/>
