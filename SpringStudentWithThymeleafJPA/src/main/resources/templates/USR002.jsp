	...
	<div id="container">
		...
		<div id="main_contents">
			<div id="contents">
				...
				<br />
				<br /> <label th:text="${msg}" style="color: blue;"></label>
				<form name="registerForm" action="/addUser" method="post" th:object="${user}">
					<table class="tableForm">
						<tr>
							<td class="tblSingleLabel">User ID *</td>
							<td class="tblSingleInput"><input type="text" id="txtUserId"
								class="txt_popup" th:field="*{userId}"  />
								<label th:if="${#fields.hasErrors('userId')}" th:errors="*{userId}"
